...
class AlienInvasion:
    ...
    def _check_play_button(self, mouse_pos):
        """ Start a new game when theplayer click play"""
    ...
    def _start_game(self):
        ...
        # Get rid of any remaining alien ans bullets
        self.bullets.empty()
        self.aliens.empty()
    ...
    def _check_keydown_events(self, event):
        ...
        if event.key == pygame.K_RIGHT:
            # Stop the movement to the rigth
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # treat the same as if the ship hits ship
                self._ship_hit()
                break

    def _ship_hit(self):
        """ Respond tho the ship being hit by an alien """
    ...
    def _create_fleet(self):
        ...
        # Determine the number of rows of aliens the fit on the screen
    ...
    def _create_alien(self, alien_number, row_number):
        ...
        alien.rect.y = 2.5 * alien.rect.height + 2 * alien.rect.height * row_number
    ...
    def _make_difficulty_buttons(self):
        """ Make buttons thar allow player to select dificulty levels """
    ...
    def _check_difficulty_buttons(self, mouse_pos):
        """ Set the appropiate dificulty level"""
